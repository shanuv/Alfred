    ...
    for (var i in all_comments) {
        ...
        if (true) {
            ...
            var divCommentHTML =
                ...
                "<div class=\"all-comment-body\"" + "\">" +
                '<div style="float: left;padding-left: 2px;"><span class="all_sentiment_icon" id="all_span_id_senti_' + divComment.id + '">' +
                "<i class=" + sent + "></i>" + "\xa0\xa0" + '</span>' +
                '<span class="all_vulgarity_icon" id="all_span_id_vul_' + divComment.id + '" >';
            ...
            divCommentHTML += '<span class="all_star_icon" id="all_span_id_star_' + divComment.id + '" >';
